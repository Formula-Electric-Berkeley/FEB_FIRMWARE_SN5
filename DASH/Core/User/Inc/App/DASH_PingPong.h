...
#ifndef DASH_PINGPONG_H
#define DASH_PINGPONG_H
...
/**
 * @brief Get TX failure count for a channel
 * @param channel Channel number (1-4)
 * @return Number of failed transmission attempts
 */
