...
FEB_CAN_Status_t FEB_CAN_TX_Init(void)
{
  ...
  FEB_CAN_Filter_Config_t reject_filter = {.filter_id = 0x7FF,   // Set to impossible ID
...
#define MAX_FILTER_IDS 32
  ...
  if (registered_count == 0)
  {
    ...
    FEB_CAN_Filter_Config_t reject_filter = {.filter_id = 0x7FF,
                                             .filter_mask = 0x7FF,
                                             .filter_mode = CAN_FILTERMODE_IDMASK,
                                             .filter_scale = CAN_FILTERSCALE_32BIT,
                                             .filter_fifo = CAN_RX_FIFO0,
  ...
  FEB_CAN_Filter_Config_t accept_filter = {.filter_id = 0x00,   // Accept base
