...
void ui_set_torque(int16_t torque)
{
  ...
  if (torque > 0)
  {
    lv_obj_set_style_text_color(ui_TorqueValue, lv_color_hex(0x00FF88), 0);
  }
  else if (torque < 0)
  {
    lv_obj_set_style_text_color(ui_TorqueValue, lv_color_hex(0xFF4444), 0);
  }
  else
  {
    lv_obj_set_style_text_color(ui_TorqueValue, lv_color_hex(0xAAAAAA), 0);
  }
}
...
void ui_init(void)
{
  ...
  lv_obj_set_style_bg_color(ui_Screen1, lv_color_hex(0x000D1A), 0); // near-black deep blue
