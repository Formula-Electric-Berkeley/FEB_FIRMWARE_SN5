 ...
 *		BM - Braking Servo, Lidar (gnd-scl) 
...
#define BM_ADDR         TPS2482_I2C_ADDR(TPS2482_I2C_ADDR_GND, TPS2482_I2C_ADDR_SCL) // A1:GND 	A0:SCL
...
#define BM_CURRENT_LSB				TPS2482_CURRENT_LSB_EQ(BM_FUSE_MAX)
...
#define BM_CAL_VAL			TPS2482_CAL_EQ(BM_CURRENT_LSB, R_SHUNT)
...
#define BM_ALERT_LIM_VAL		TPS2482_SHUNT_VOLT_REG_VAL_EQ((uint16_t)(BM_FUSE_MAX / BM_CURRENT_LSB),             BM_CAL_VAL)
...
#define BM_POWER_LSB	    TPS2482_POWER_LSB_EQ(BM_CURRENT_LSB)
