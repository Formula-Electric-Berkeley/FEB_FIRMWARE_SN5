 ...
 * @details
 *
 * Provides a 64-bit microsecond clock backed by the Cortex-M4 DWT cycle
 * counter. Zero peripheral cost - uses only the CoreDebug/DWT core units
 * present on every Cortex-M4 (all F446RE boards in this repo).
 *
 * Usage:
