 ...
 *
 */
int32_t __weak lis3mdl_read_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len)
{
  int32_t ret;
 ...
 *
 */
int32_t __weak lis3mdl_write_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len)
{
  int32_t ret;
 ...
 *
 */
int32_t lis3mdl_operating_mode_set(const stmdev_ctx_t *ctx, lis3mdl_md_t val)
{
 ...
 *
 */
int32_t lis3mdl_operating_mode_get(const stmdev_ctx_t *ctx, lis3mdl_md_t *val)
{
  lis3mdl_ctrl_reg3_t ctrl_reg3;
  int32_t ret;
 ...
 *
 */
int32_t lis3mdl_status_get(const stmdev_ctx_t *ctx, lis3mdl_status_reg_t *val)
{
 ...
 *
 */
int32_t lis3mdl_int_config_set(const stmdev_ctx_t *ctx, lis3mdl_int_cfg_t *val)
{
 ...
 *
 */
int32_t lis3mdl_int_config_get(const stmdev_ctx_t *ctx, lis3mdl_int_cfg_t *val)
{
 ...
 *
 */
int32_t lis3mdl_int_notification_mode_set(const stmdev_ctx_t *ctx, lis3mdl_lir_t val)
{
  lis3mdl_int_cfg_t int_cfg;
  int32_t ret;
 ...
 *
 */
int32_t lis3mdl_int_notification_mode_get(const stmdev_ctx_t *ctx, lis3mdl_lir_t *val)
{
  lis3mdl_int_cfg_t int_cfg;
  int32_t ret;
 ...
 *
 */
int32_t lis3mdl_int_polarity_get(const stmdev_ctx_t *ctx, lis3mdl_iea_t *val)
{
  lis3mdl_int_cfg_t int_cfg;
  int32_t ret;
 ...
 *
 */
int32_t lis3mdl_int_source_get(const stmdev_ctx_t *ctx, lis3mdl_int_src_t *val)
{
 ...
 *
 */
int32_t lis3mdl_interrupt_event_flag_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
 ...
 *
 */
int32_t lis3mdl_int_mag_over_range_flag_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  lis3mdl_int_src_t int_src;
  int32_t ret;
