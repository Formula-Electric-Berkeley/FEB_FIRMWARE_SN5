/**
 ******************************************************************************
 * @file           : FEB_SN_PingPong.h
 * @brief          : CAN Ping/Pong Test Module Header (Sensor Node)
 * @author         : Formula Electric @ Berkeley
 ******************************************************************************
 *
 * Ported from LVPDB/Core/User/.../FEB_CAN_PingPong.{h,c}. Same 4-channel
 * request/response protocol on CAN1, frame IDs 0xE0-0xE3, int32 counter
 * (little-endian) in the first 4 payload bytes. Exposed on the console under
 * the SN| command (SN|ping|<1-4>, SN|pong|<1-4>, SN|stop|<1-4|all>,
 * SN|canstatus).
 *
 * NOTE (repo Rule 1): this duplicates LVPDB's module. The cleaner long-term
 * home is common/feb_can_pingpong linked by both boards.
 ******************************************************************************
 */
