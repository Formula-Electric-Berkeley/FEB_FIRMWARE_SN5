...
#define __weak __attribute__((weak))
  ...
  int32_t lsm6dsox_read_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len);
  int32_t lsm6dsox_write_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data, uint16_t len);
  ...
  int32_t lsm6dsox_ln_pg_read(const stmdev_ctx_t *ctx, uint16_t address, uint8_t *val);
  ...
  int32_t lsm6dsox_pedo_adv_detection_set(const stmdev_ctx_t *ctx, uint8_t val);
  int32_t lsm6dsox_pedo_adv_detection_get(const stmdev_ctx_t *ctx, uint8_t *val);

  int32_t lsm6dsox_pedo_false_step_rejection_set(const stmdev_ctx_t *ctx, uint8_t val);
  int32_t lsm6dsox_pedo_false_step_rejection_get(const stmdev_ctx_t *ctx, uint8_t *val);
  ...
  int32_t lsm6dsox_calibration_get(const stmdev_ctx_t *ctx, lsm6dsox_dev_cal_t *val);
  ...
  typedef struct
  {
    struct
    {
      struct
      {
        lsm6dsox_ui_xl_odr_t odr;
        lsm6dsox_ui_xl_fs_t fs;
      } xl;
      struct
      {
        lsm6dsox_ui_gy_odr_t odr;
        lsm6dsox_ui_gy_fs_t fs;
      } gy;
    } ui;
    struct
    {
    ...
    struct
    {
      lsm6dsox_fsm_sens_t sens;
      lsm6dsox_fsm_odr_t odr;
    } fsm;
    struct
    {
  ...
  int32_t lsm6dsox_embedded_sens_set(const stmdev_ctx_t *ctx, lsm6dsox_emb_sens_t *emb_sens);
