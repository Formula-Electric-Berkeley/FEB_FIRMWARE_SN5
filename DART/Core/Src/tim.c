...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = PWM5_Pin|PWM4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TACH4_Pin|TACH5_Pin);
  ...
  /* USER CODE END TIM14_MspDeInit 0 */
    ...
    PA4     ------> TIM14_CH1
    */
    HAL_GPIO_DeInit(TACH1_GPIO_Port, TACH1_Pin);
  ...
  /* USER CODE END TIM16_MspDeInit 0 */
    ...
    PA6     ------> TIM16_CH1
    */
    HAL_GPIO_DeInit(TACH2_GPIO_Port, TACH2_Pin);
  ...
  /* USER CODE END TIM17_MspDeInit 0 */
    ...
    PA7     ------> TIM17_CH1
    */
    HAL_GPIO_DeInit(TACH3_GPIO_Port, TACH3_Pin);
