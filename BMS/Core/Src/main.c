...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(
      GPIOC, INDICATOR_Pin | BMS_INDICATOR_Pin | BMS_LED_INDICATOR_Pin | PC_AIR__Pin | SPI1_CS_Pin | AIR_P_SENSE_Pin,
      GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin =
      INDICATOR_Pin | BMS_INDICATOR_Pin | BMS_LED_INDICATOR_Pin | PC_AIR__Pin | SPI1_CS_Pin | AIR_P_SENSE_Pin;
  ...
  /*Configure GPIO pins : WAKE_Pin INTERRUPT_Pin BMS_RESET_Pin PG_Pin
                           ALERT_Pin */
  GPIO_InitStruct.Pin = WAKE_Pin | INTERRUPT_Pin | BMS_RESET_Pin | PG_Pin | ALERT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
