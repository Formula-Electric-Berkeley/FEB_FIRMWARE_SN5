...
#define TPS2482_CURRENT_REG_VAL_EQ(a1, a0) (uint16_t)((a1 * a0) / (2048))

// eq. 22 (modified), a1 = CurrentRegValue, a0 = CAL
#define TPS2482_SHUNT_VOLT_REG_VAL_EQ(a1, a0) (uint16_t)((a1 * 2048) / a0)

// eq. 23, a1 = CurrentRegValue, a0 = BusVoltageRegValue
#define TPS2482_POWER_REG_VAL_EQ(a1, a0) (uint16_t)((a1 * a0) / (20000))
...
void TPS2482_Init(I2C_HandleTypeDef *hi2c, uint8_t *addresses, TPS2482_Configuration *configurations, uint16_t *ids,
                  bool *result, uint8_t messageCount);
