...
{
  return (mux == 5 && channel == 4) || (mux == 3 && channel == 0) || (mux == 3 && channel == 4) ||
         (mux == 0 && channel == 2) || (mux == 0 && channel == 3) || (mux == 5 && channel == 0) ||
         (mux == 2 && channel == 1) || (mux == 2 && channel == 1) || (mux == 2 && channel == 5) ||
         (mux == 5 && channel == 1) || (mux == 5 && channel == 2) || (mux == 5 && channel == 3);
}
